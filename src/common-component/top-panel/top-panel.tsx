    ...
    <div className="top-header-panel">
      <div className="top-sections">
        ...
        <div className="search-section">
          {config?.buttons?.includes("search") && <img src="/assets/icons/search-icon.svg"></img>}
           {config?.buttons?.includes("add") &&<img src="/assets/icons/add.svg" onClick={handleModal}></img>}
